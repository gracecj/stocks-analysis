...
---
::: {.callout-note}
This tool was created by Grace Johnson to access current stock prices using Yahoo Finance.
:::
```{python}
...
def current_datetime_in_est():
    ...
    return est_now.strftime('%Y-%m-%d %I:%M:%S %p %Z')

print("Current date and time in EST:", current_datetime_in_est())
```
```{python}
import helpers
...
information = [
    "Information about Adidas",
    "Information about Birkenstock",
    "Information about Dr. Martens",
    "Information about Logitech",
    "Information about L'Oreal",
    "Information about Nintendo",
    "Information about Samsung",
    "Information about Shiseido",
